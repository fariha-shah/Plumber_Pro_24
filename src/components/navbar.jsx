...
// ✅ Use these instead - available in lucide-react
  ...
  return (
    <header className="w-full sticky top-0 z-50">
      ...
      <div
        ...
        px-4 md:px-10 py-2 flex items-center justify-between text-xs text-[#64748B]"
      >
        {/* Left - Address info */}
        {/* Left - Address info */}
        ...
        <div className="flex items-center gap-2 ml-auto">
          ...
          <a
            href="#"
            className="w-6 h-6 bg-[#F1F5F9] rounded flex items-center
      justify-center hover:bg-blue-50 transition"
          >
      ...
      {/* ── MAIN NAVBAR ── */}
      <nav
        className="bg-white shadow-sm px-4 md:px-10 py-4
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-3">
          {/* Contact Us - outlined pink/magenta */}
          <Link
            to="/contact"
            className="px-5 py-4 border-2 border-pink-500 text-pink-500
          ...
          {/* Appointment - solid blue */}
          <Link
            to="/booking"
            className="px-5 py-4 bg-[#2563EB] text-white
              rounded-lg text-xs font-bold tracking-wider uppercase
      ...
      {menuOpen && (
        <div
          ...
          px-6 pb-6 flex flex-col gap-3 shadow-lg"
        >
          {navLinks.map((link) => (
            <Link
              key={link.path}
          ...
          <div className="flex flex-col gap-2 mt-2">
            <Link
              ...
              className="py-3 text-center border-2 border-pink-500
                text-pink-500 rounded-full text-xs font-bold uppercase
                hover:bg-pink-500 hover:text-white transition"
            >
              CONTACT US
            </Link>
